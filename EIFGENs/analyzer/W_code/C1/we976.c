...
extern EIF_TYPED_VALUE F976_8785(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F976_8785 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 975, Current, 0, 1, 15058);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(975, Current, 15058);
	RTIV(Current, RTAL);
	RTHOOK(1);
