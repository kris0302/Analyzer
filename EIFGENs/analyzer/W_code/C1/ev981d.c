...
static const struct desc_info desc_981[] = {
	...
	{EIF_NON_GENERIC(0x0195 /*202*/), 15103, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0195 /*202*/), 15104, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0195 /*202*/), 15105, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15106, 0},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15107, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15108, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15109, 0xFFFFFFFF},
};
void Init981(void)
{
	IDSC(desc_981, 0, 980);
	IDSC(desc_981 + 1, 1, 980);
	IDSC(desc_981 + 32, 1228, 980);
}
