...
extern void F959_7085(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F959_7090(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#ifndef INLINE_F959_7089
static EIF_INTEGER_32 inline_F959_7089 (void)
{
	{
...
#define INLINE_F959_7089
#endif
#ifndef INLINE_F959_7090
static EIF_NATURAL_64 inline_F959_7090 (EIF_POINTER arg1)
{
	{
...
void F959_7085 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 958, Current, 0, 0, 13358);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4923, 0xF80000AA, 0); /* item */
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 958, Current, 0, 0, 13360);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((EIF_BOOLEAN)(tp1 != tp2)) {
		...
		tp1 = *(EIF_POINTER *)(tr1 + RTVA(3213, "item", tr1));
		up1 = tp1;
		Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4925, dtype))(Current, up1x)).it_n8);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
EIF_TYPED_VALUE F959_7089 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 958, Current, 0, 0, 13362);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(958, Current, 13362);
	RTIV(Current, RTAL);
	Result = inline_F959_7089 ();
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
	RTDBGLE;
...
EIF_TYPED_VALUE F959_7090 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTIV(Current, RTAL);
	Result = inline_F959_7090 ((EIF_POINTER) arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
	RTDBGLE;
