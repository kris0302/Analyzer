...
extern void F1203_12486(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1203_12487(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1203_12488(EIF_REFERENCE);
extern void F1203_12489(EIF_REFERENCE);
extern void F1203_12490(EIF_REFERENCE);
...
void F1203_12486 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1202, Current, 0, 1, 18728);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10294, 0x10000000, 1); /* scale_width */
	*(EIF_INTEGER_32 *)(Current + RTWA(10294, dtype)) = (EIF_INTEGER_32) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
void F1203_12487 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1202, Current, 0, 1, 18729);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1202, Current, 18729);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10295, 0x10000000, 1); /* scale_height */
...
void F1203_12488 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1202, Current, 0, 0, 18730);
	RTSA(Dtype(Current));
	RTSC;
...
void F1203_12489 (EIF_REFERENCE Current)
{
	GTCX
...
void F1203_12490 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1202, Current, 0, 0, 18732);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1202, Current, 18732);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
