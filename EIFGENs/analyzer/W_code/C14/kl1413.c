...
extern EIF_TYPED_VALUE F1413_14527(EIF_REFERENCE);
...
RTOID (F1413_14527)
EIF_TYPED_VALUE F1413_14527 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1412, Current, 0, 0, 21213);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1412, Current, 21213);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
