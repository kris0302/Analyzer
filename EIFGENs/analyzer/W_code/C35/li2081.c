/*
 * Code for class LINKED_LIST_CURSOR [INTEGER_64]
 */
...
extern void F2081_3016(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2081_3017(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2081_3018(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2081_3019(EIF_REFERENCE);
extern void F2081_7031(EIF_REFERENCE, int);
...
void F2081_3016 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 2080, Current, 0, 3, 20456);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2080, Current, 20456);
	RTCC(arg1, 2080, l_feature_name, 1, RTWCT(2497, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 2497, 0xF8000821, 0); /* active */
	RTAR(Current, arg1);
...
EIF_TYPED_VALUE F2081_3017 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F2081_3018 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F2081_3019 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F2081_7031 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 2080, Current, 0, 7030);
	RTSA(dtype);
	RTME(dtype, 0);
