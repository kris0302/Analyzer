...
extern void F1760_19506(EIF_REFERENCE);
static EIF_TYPED_VALUE F1760_19508_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1760_19508(EIF_REFERENCE);
...
void F1760_19506 (EIF_REFERENCE Current)
{
	GTCX
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		if ((EIF_BOOLEAN) !tb2) {
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16218, dtype))(Current)).it_b);
			tb1 = tb2;
		}
		RTTE(tb1, label_1);
		RTCK;
...
static EIF_TYPED_VALUE F1760_19508_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1760_19508 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15652, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1760_19508_body (Current)).it_r;
