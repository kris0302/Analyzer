...
extern void F1611_17529(EIF_REFERENCE);
extern void F1611_17530(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {IMPLY}.make_imply */
void F1611_17529 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "make_imply";
	RTEX;
...
/* {IMPLY}.accept */
void F1611_17530 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1610, Current, 0, 1, 24277);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1610, Current, 24277);
	RTCC(arg1, 1610, l_feature_name, 1, eif_new_type(1269, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10815, "visit_imply", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
