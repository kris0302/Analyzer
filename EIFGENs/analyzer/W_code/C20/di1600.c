...
extern void F1600_17506(EIF_REFERENCE);
extern void F1600_17507(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {DISJOIN}.make_disjoin */
void F1600_17506 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "make_disjoin";
	RTEX;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1599, Current, 0, 0, 24253);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1599, Current, 24253);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DISJOIN}.accept */
void F1600_17507 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1599, Current, 0, 1, 24254);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1599, Current, 24254);
	RTCC(arg1, 1599, l_feature_name, 1, eif_new_type(1269, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10814, "visit_disjoin", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
