...
extern void F1607_17521(EIF_REFERENCE);
extern void F1607_17522(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {UNION}.make_union */
void F1607_17521 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "make_union";
	RTEX;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1606, Current, 0, 0, 24268);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1606, Current, 24268);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {UNION}.accept */
void F1607_17522 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1606, Current, 0, 1, 24269);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1606, Current, 24269);
	RTCC(arg1, 1606, l_feature_name, 1, eif_new_type(1269, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10819, "visit_union", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
