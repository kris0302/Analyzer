...
extern void F1598_17502(EIF_REFERENCE);
extern void F1598_17503(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1598_17502 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1597, Current, 0, 0, 24249);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {NEGATION}.accept */
void F1598_17503 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTCC(arg1, 1597, l_feature_name, 1, eif_new_type(1269, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10825, "visit_negation", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
