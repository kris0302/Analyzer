...
extern void F1610_17527(EIF_REFERENCE);
extern void F1610_17528(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {EQUALS}.make_equals */
void F1610_17527 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "make_equals";
	RTEX;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1609, Current, 0, 0, 24274);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1609, Current, 24274);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EQUALS}.accept */
void F1610_17528 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1609, Current, 0, 1, 24275);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1609, Current, 24275);
	RTCC(arg1, 1609, l_feature_name, 1, eif_new_type(1269, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10816, "visit_equals", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
