...
extern void F1599_17504(EIF_REFERENCE);
extern void F1599_17505(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1599_17504 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "make_subtraction";
	RTEX;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1598, Current, 0, 0, 24251);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1598, Current, 24251);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {SUBTRACTION}.accept */
void F1599_17505 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1598, Current, 0, 1, 24252);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1598, Current, 24252);
	RTCC(arg1, 1598, l_feature_name, 1, eif_new_type(1269, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10810, "visit_subtraction", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
