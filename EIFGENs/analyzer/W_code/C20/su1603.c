...
extern void F1603_17512(EIF_REFERENCE);
extern void F1603_17513(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {SUM}.make_sum */
void F1603_17512 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1602, Current, 0, 0, 24259);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1602, Current, 24259);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {SUM}.accept */
void F1603_17513 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1602, Current, 0, 1, 24260);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1602, Current, 24260);
	RTCC(arg1, 1602, l_feature_name, 1, eif_new_type(1269, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10826, "visit_sum", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
