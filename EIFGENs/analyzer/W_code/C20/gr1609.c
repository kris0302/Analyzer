...
extern void F1609_17525(EIF_REFERENCE);
extern void F1609_17526(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {GREATER_THAN}.make_gt */
void F1609_17525 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "make_gt";
	RTEX;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1608, Current, 0, 0, 24272);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1608, Current, 24272);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {GREATER_THAN}.accept */
void F1609_17526 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1608, Current, 0, 1, 24273);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1608, Current, 24273);
	RTCC(arg1, 1608, l_feature_name, 1, eif_new_type(1269, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10817, "visit_gt", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
