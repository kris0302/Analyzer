...
extern void F1608_17523(EIF_REFERENCE);
extern void F1608_17524(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {LESS_THAN}.make_lt */
void F1608_17523 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1607, Current, 0, 0, 24270);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1607, Current, 24270);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {LESS_THAN}.accept */
void F1608_17524 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1607, Current, 0, 1, 24271);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1607, Current, 24271);
	RTCC(arg1, 1607, l_feature_name, 1, eif_new_type(1269, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10818, "visit_lt", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
