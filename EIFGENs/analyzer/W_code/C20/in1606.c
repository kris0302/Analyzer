...
extern void F1606_17519(EIF_REFERENCE);
extern void F1606_17520(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1606_17519 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "make_intersection";
	RTEX;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1605, Current, 0, 0, 24266);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1605, Current, 24266);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {INTERSECTION}.accept */
void F1606_17520 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1605, Current, 0, 1, 24267);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1605, Current, 24267);
	RTCC(arg1, 1605, l_feature_name, 1, eif_new_type(1269, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10820, "visit_intersection", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
