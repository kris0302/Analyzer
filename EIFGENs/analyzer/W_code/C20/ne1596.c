...
extern void F1596_17498(EIF_REFERENCE);
extern void F1596_17499(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1596_17498 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1595, Current, 0, 0, 24245);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1595, Current, 24245);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {NEGATIVE}.accept */
void F1596_17499 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1595, Current, 0, 1, 24246);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1595, Current, 24246);
	RTCC(arg1, 1595, l_feature_name, 1, eif_new_type(1269, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10824, "visit_negative", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
