...
extern void F1605_17517(EIF_REFERENCE);
extern void F1605_17518(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {DIFFERENCE}.make_diff */
void F1605_17517 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "make_diff";
	RTEX;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1604, Current, 0, 0, 24264);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1604, Current, 24264);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DIFFERENCE}.accept */
void F1605_17518 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1604, Current, 0, 1, 24265);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1604, Current, 24265);
	RTCC(arg1, 1604, l_feature_name, 1, eif_new_type(1269, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10821, "visit_difference", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
