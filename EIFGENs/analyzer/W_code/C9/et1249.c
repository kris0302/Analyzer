...
extern void F1249_12813(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1249_12814(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1249_12815(EIF_REFERENCE);
extern void F1249_12816(EIF_REFERENCE);
extern void F1249_12817(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1249_12813 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1248, Current, 1, 0, 19034);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1248, Current, 19034);
	RTIV(Current, RTAL);
	wstdinit(loc1,loc1);
	RTLXI(loc1);
	RTHOOK(1);
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10567, 0xF8000405, 0); /* model */
	...
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(10567, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
EIF_TYPED_VALUE F1249_12814 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(10567,Dtype(Current)));
	return r;
}


/* {ETF_CMD_LINE_OUTPUT_HANDLER}.model_state */
EIF_TYPED_VALUE F1249_12815 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1248, Current, 0, 0, 19036);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1248, Current, 19036);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10567, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(2,1);
...
void F1249_12816 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1248, Current, 0, 0, 19037);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1248, Current, 19037);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1249_12817 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1248, Current, 1, 1, 19038);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1248, Current, 19038);
	RTCC(arg1, 1248, l_feature_name, 1, eif_new_type(1358, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 0L))) {
		...
		*(EIF_REFERENCE *)(Current + RTWA(10559, dtype)) = (EIF_REFERENCE) RTCCL(tr2);
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10559, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(4,1);
		tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10568, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		ur1 = RTCCL(tr2);
