...
extern void F1222_12709(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1222_12710(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1222_12711(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1222_12712(EIF_REFERENCE);
...
/* {ETF_ENUM_PARAM}.make */
void F1222_12709 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1221, Current, 0, 1, 18935);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1221, Current, 18935);
	{
		...
		RTCC(arg1, 1221, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 10506, 0xF8000107, 0); /* items */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(10506, Dtype(Current))) = (EIF_REFERENCE) RTCCL(arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1222_12710 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1222_12711 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1221, Current, 0, 0, 18932);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1221, Current, 18932);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1222_12712 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1221, Current, 1, 0, 18933);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1221, Current, 18933);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000E7, 0,0); /* Result */
	...
	for (;;) {
		...
		RTHOOK(5);
		tr1 = RTMS_EX_H("\"",1,34);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10506, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ui4_1 = loc1;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1221, Current, 1, 0, 18934);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1221, Current, 18934);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000E7, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(231, 0x01).id);
