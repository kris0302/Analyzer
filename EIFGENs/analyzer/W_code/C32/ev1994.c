...
extern void F1994_24187(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1994_24188(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1994_24189(EIF_REFERENCE);
extern void F1994_24190(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1994_24191(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1994_24192(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1994_24193(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1994_24194(EIF_REFERENCE);
extern void F1994_24195(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1994_24196_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1994_24196(EIF_REFERENCE);
...
void F1994_24187 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1993, Current, 0, 1, 30151);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 30151);
	RTCC(arg1, 1993, l_feature_name, 1, RTWCT(15652, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
/* {EV_CELL_IMP}.make */
void F1994_24188 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1993, Current, 0, 0, 30152);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 30152);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1994_24189 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1994_24190 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1993, Current, 1, 1, 30154);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 30154);
	if (arg1) {
		RTCC(arg1, 1993, l_feature_name, 1, eif_new_type(1996, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1994_24191 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1993, Current, 2, 1, 30155);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 30155);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1994_24192 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1993, Current, 2, 1, 30156);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 30156);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
...
void F1994_24193 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1993, Current, 3, 1, 30157);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 30157);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1994_24194 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1993, Current, 0, 0, 30158);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 30158);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1994_24195 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1993, Current, 0, 2, 30159);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 30159);
	RTCC(arg1, 1993, l_feature_name, 1, eif_new_type(1555, 0x01), 0x01);
	RTCC(arg2, 1993, l_feature_name, 2, eif_new_type(1531, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
static EIF_TYPED_VALUE F1994_24196_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1993, Current, 0, 0, 30160);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1993, Current, 30160);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1994_24196 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15652, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1994_24196_body (Current)).it_r;
