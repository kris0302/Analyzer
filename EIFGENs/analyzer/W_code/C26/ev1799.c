...
extern EIF_TYPED_VALUE F1799_19921(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1799_19922(EIF_REFERENCE);
extern void F1799_19930(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1799_19931_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1799_19931(EIF_REFERENCE);
extern void F1799_25677(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1799_19921 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(16574,Dtype(Current)));
	return r;
}


/* {EV_GAUGE_I}.proportion */
EIF_TYPED_VALUE F1799_19922 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1798, Current, 2, 0, 26269);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1798, Current, 26269);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(loc1 != loc2)) {
		...
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16571, dtype))(Current)).it_i4);
...
void F1799_19930 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1798, Current, 2, 1, 26270);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1798, Current, 26270);
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(loc1 != loc2)) {
		...
		*(EIF_REAL_32 *)tr1 = (EIF_REAL_32) (tr4_1 * arg1);
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(16580, dtype))(Current, ui4_1x);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(6);
...
static EIF_TYPED_VALUE F1799_19931_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1798, Current, 0, 0, 26271);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1798, Current, 26271);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1799_19931 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15652, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1799_19931_body (Current)).it_r;
...
void F1799_25677 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1798, Current, 0, 25676);
	RTSA(dtype);
	RTME(dtype, 0);
