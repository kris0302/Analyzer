...
extern EIF_TYPED_VALUE F1797_19887(EIF_REFERENCE);
extern void F1797_19892(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1797_19893(EIF_REFERENCE);
static EIF_TYPED_VALUE F1797_19894_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1797_19894(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1797_19887 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1796, Current, 1, 0, 26259);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1796, Current, 26259);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,245,0xFF01,1695,0xFFFF};
		EIF_TYPE typres0;
	...
	for (;;) {
		...
		RTNHOOK(5,2);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15053, "is_selected", tr2))(tr2)).it_b);
		if (tb2) {
			RTHOOK(6);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15651, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(6,1);
...
void F1797_19892 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1796, Current, 0, 0, 26260);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1796, Current, 26260);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 16552, 0x04000000, 1); /* default_key_processing_disabled */
	*(EIF_BOOLEAN *)(Current + RTWA(16552, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1797_19893 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(16552,Dtype(Current)));
	return r;
}


/* {EV_LIST_I}.interface */
static EIF_TYPED_VALUE F1797_19894_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1796, Current, 0, 0, 26262);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1796, Current, 26262);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1797_19894 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15652, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1797_19894_body (Current)).it_r;
