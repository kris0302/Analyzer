...
static EIF_TYPED_VALUE F1811_20038_body(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1810, Current, 1, 0, 26305);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1810, Current, 26305);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		{
			static EIF_TYPE_INDEX typarr0[] = {2048,0xFF01,1693,0xFFFF};
			EIF_TYPE typres0;
...
/* {EV_ITEM_I}.interface */
static EIF_TYPED_VALUE F1811_20038_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1810, Current, 0, 0, 26306);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1810, Current, 26306);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1811_20038 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15652, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1811_20038_body (Current)).it_r;
