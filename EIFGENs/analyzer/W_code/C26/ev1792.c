...
extern void F1792_19869(EIF_REFERENCE);
static EIF_TYPED_VALUE F1792_19873_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1792_19873(EIF_REFERENCE);
...
/* {EV_TREE_I}.make */
void F1792_19869 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1791, Current, 0, 0, 26252);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1791, Current, 26252);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_TREE_I}.interface */
static EIF_TYPED_VALUE F1792_19873_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1791, Current, 0, 0, 26251);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1791, Current, 26251);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1792_19873 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15652, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1792_19873_body (Current)).it_r;
