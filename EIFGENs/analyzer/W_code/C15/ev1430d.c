...
static const EIF_TYPE_INDEX egt_13_1430 [] = {0xFF01,245,0xFF01,237,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1430 [] = {371,0xFF01,1524,0xFF01,237,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1430 [] = {371,0xFF01,1523,0xFF01,237,0xFFFF};
static const EIF_TYPE_INDEX egt_16_1430 [] = {245,0xFF01,237,0xFFFF};
...
static const struct desc_info desc_1430[] = {
	...
	{EIF_NON_GENERIC(0x0195 /*202*/), 21504, 0xFFFFFFFF},
	{EIF_GENERIC(egt_13_1430), 21499, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1430), 21500, 0},
	{EIF_GENERIC(egt_15_1430), 21501, 8},
	{EIF_GENERIC(egt_16_1430), 21503, 16},
};
void Init1430(void)
{
	IDSC(desc_1430, 0, 1429);
	IDSC(desc_1430 + 1, 1, 1429);
	IDSC(desc_1430 + 32, 1259, 1429);
	IDSC(desc_1430 + 36, 213, 1429);
	IDSC(desc_1430 + 38, 1028, 1429);
	IDSC(desc_1430 + 49, 752, 1429);
}
