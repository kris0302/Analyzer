...
extern EIF_TYPED_VALUE F1162_11700(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1162_11701(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1162_11700 (EIF_REFERENCE Current)
{
	GTCX
...
RTOID (F1162_11701)
EIF_TYPED_VALUE F1162_11701 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1161, Current, 0, 0, 17975);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,326,1928,0xFFFF};
		EIF_TYPE typres0;
