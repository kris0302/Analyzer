...
extern EIF_TYPED_VALUE F1295_13793(EIF_REFERENCE);
...
RTOID (F1295_13793)
EIF_TYPED_VALUE F1295_13793 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1294, Current, 0, 0, 20123);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1294, Current, 20123);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
