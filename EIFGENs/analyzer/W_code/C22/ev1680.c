...
extern EIF_TYPED_VALUE F1680_18452(EIF_REFERENCE);
extern void F1680_18453(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1680_18452 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1680_18453 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1679, Current, 0, 0, 25208);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1679, Current, 25208);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14761, 0xF8000702, 0); /* implementation */
	tr1 = RTLN(eif_new_type(2013, 0x01).id);
