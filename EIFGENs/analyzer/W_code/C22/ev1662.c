...
extern EIF_TYPED_VALUE F1662_18214(EIF_REFERENCE);
extern void F1662_18215(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1662_18214 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1662_18215 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1661, Current, 0, 0, 24970);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1661, Current, 24970);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14761, 0xF80006F2, 0); /* implementation */
