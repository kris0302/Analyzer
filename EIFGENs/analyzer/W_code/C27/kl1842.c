...
extern EIF_TYPED_VALUE F1842_20305(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1842_20305 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1841, Current, 0, 0, 26489);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1841, Current, 26489);
	RTIV(Current, RTAL);
	RTHOOK(1);
