...
extern EIF_TYPED_VALUE F1090_10478(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1090_10478 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1089, Current, 0, 0, 16794);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1089, Current, 16794);
	RTIV(Current, RTAL);
