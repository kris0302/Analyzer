...
extern EIF_TYPED_VALUE F1101_10548(EIF_REFERENCE);
...
RTOID (F1101_10548)
EIF_TYPED_VALUE F1101_10548 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1100, Current, 0, 0, 16848);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1100, Current, 16848);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
