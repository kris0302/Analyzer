...
extern EIF_TYPED_VALUE F1343_14242(EIF_REFERENCE);
...
RTOID (F1343_14242)
EIF_TYPED_VALUE F1343_14242 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1342, Current, 0, 0, 20905);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1342, Current, 20905);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
