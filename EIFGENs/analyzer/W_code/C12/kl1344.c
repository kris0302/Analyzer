...
extern EIF_TYPED_VALUE F1344_14243(EIF_REFERENCE);
...
RTOID (F1344_14243)
EIF_TYPED_VALUE F1344_14243 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1343, Current, 0, 0, 20906);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1343, Current, 20906);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
