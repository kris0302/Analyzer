...
extern EIF_TYPED_VALUE F1911_21939(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1911_21940(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1911_21941(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1911_21942(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1911_21939 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1910, Current, 1, 0, 28003);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1910, Current, 28003);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1911_21940 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1910, Current, 1, 0, 28004);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1910, Current, 28004);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF8000734, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1844, 0x01).id);
...
EIF_TYPED_VALUE F1911_21941 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1910, Current, 1, 0, 28005);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1910, Current, 28005);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF8000734, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1844, 0x01).id);
...
EIF_TYPED_VALUE F1911_21942 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1910, Current, 1, 0, 28006);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1910, Current, 28006);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF8000734, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1844, 0x01).id);
