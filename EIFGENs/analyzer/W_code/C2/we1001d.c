...
static const struct desc_info desc_1001[] = {
	...
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15345, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15346, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15347, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15348, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15349, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15350, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15351, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15352, 0xFFFFFFFF},
};
void Init1001(void)
{
	IDSC(desc_1001, 0, 1000);
	IDSC(desc_1001 + 1, 1, 1000);
	IDSC(desc_1001 + 32, 987, 1000);
}
