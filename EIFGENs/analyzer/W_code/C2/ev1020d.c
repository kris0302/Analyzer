...
static const struct desc_info desc_1020[] = {
	...
	{EIF_NON_GENERIC(0x01A1 /*208*/), 15904, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A1 /*208*/), 15905, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A1 /*208*/), 15906, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A1 /*208*/), 15907, 0xFFFFFFFF},
	...
	{EIF_NON_GENERIC(0x01A1 /*208*/), 15917, 8},
	{EIF_NON_GENERIC(0x01A1 /*208*/), 15918, 9},
	{EIF_NON_GENERIC(0x01A1 /*208*/), 15919, 10},
	{EIF_NON_GENERIC(0x01A1 /*208*/), 15920, 11},
	{EIF_GENERIC(NULL), 15898, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 15899, 12},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 15900, 16},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 15901, 20},
	{EIF_NON_GENERIC(0x0D7B /*1725*/), 15902, 0},
};
void Init1020(void)
{
	IDSC(desc_1020, 0, 1019);
	IDSC(desc_1020 + 1, 1, 1019);
	IDSC(desc_1020 + 32, 678, 1019);
}
