...
extern void F1557_17316(EIF_REFERENCE);
extern void F1557_17317(EIF_REFERENCE);
extern void F1557_17318(EIF_REFERENCE);
extern void F1557_17319(EIF_REFERENCE);
...
/* {WEL_SCREEN_DC}.get */
void F1557_17316 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1556, Current, 1, 0, 24021);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1556, Current, 24021);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1557_17317 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1556, Current, 1, 0, 24022);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1556, Current, 24022);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = *(EIF_POINTER *)(Current + RTWA(12220, dtype));
	if ((EIF_BOOLEAN)(tp1 != loc1)) {
...
void F1557_17318 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1556, Current, 1, 0, 24023);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1556, Current, 24023);
	RTIV(Current, RTAL);
...
void F1557_17319 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1556, Current, 1, 0, 24024);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1556, Current, 24024);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
