...
extern EIF_TYPED_VALUE F1874_20832(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1874_20833(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1874_20832 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1873, Current, 0, 0, 26956);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1873, Current, 26956);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1874_20833 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1873, Current, 0, 0, 26957);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1873, Current, 26957);
	RTIV(Current, RTAL);
	RTHOOK(1);
