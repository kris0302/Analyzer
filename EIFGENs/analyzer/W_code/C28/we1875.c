...
extern EIF_TYPED_VALUE F1875_20834(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1875_20834 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1874, Current, 0, 0, 26958);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1874, Current, 26958);
	RTIV(Current, RTAL);
	RTHOOK(1);
