...
extern void F2021_24999(EIF_REFERENCE);
extern void F2021_25000(EIF_REFERENCE);
extern void F2021_25001(EIF_REFERENCE);
extern void F2021_25002(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2021_25003(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2021_25004(EIF_REFERENCE);
extern void F2021_25005(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F2021_25006_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2021_25006(EIF_REFERENCE);
...
void F2021_24999 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 2020, Current, 0, 0, 30949);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2020, Current, 30949);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(15647, 2019))(Current);
	RTHOOK(2);
...
void F2021_25000 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2020, Current, 2, 0, 30950);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2020, Current, 30950);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(19426, 2019))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(7);
	RTDBGLE;
...
void F2021_25001 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 2020, Current, 0, 0, 30951);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2020, Current, 30951);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(16220, 2019))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
void F2021_25002 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 2020, Current, 0, 0, 30952);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2020, Current, 30952);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_selectable", EX_PRE);
...
body:;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(7402, 1017))(Current, up1x, ui4_1x, up2x, up3x);
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(16222, 2019))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F2021_25003 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2020, Current, 0, 0, 30953);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(2020, Current, 30953);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F2021_25004 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2020, Current, 0, 0, 30954);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2020, Current, 30954);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
void F2021_25005 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2020, Current, 0, 1, 30955);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2020, Current, 30955);
	RTCC(arg1, 2020, l_feature_name, 1, eif_new_type(1626, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
static EIF_TYPED_VALUE F2021_25006_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2020, Current, 0, 0, 30956);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(2020, Current, 30956);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F2021_25006 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15652, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F2021_25006_body (Current)).it_r;
