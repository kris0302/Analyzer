...
extern EIF_TYPED_VALUE F1689_18591(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1689_18592(EIF_REFERENCE);
extern void F1689_18593(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1689_18591 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1688, Current, 0, 0, 25349);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1688, Current, 25349);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(14766, 1682))(Current)).it_b);
	if (tb2) {
...
EIF_TYPED_VALUE F1689_18592 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1689_18593 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1688, Current, 0, 0, 25351);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1688, Current, 25351);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14761, 0xF800070D, 0); /* implementation */
	tr1 = RTLN(eif_new_type(2016, 0x01).id);
