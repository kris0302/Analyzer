...
extern EIF_TYPED_VALUE F1705_18663(EIF_REFERENCE);
extern void F1705_18664(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1705_18663 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1705_18664 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1704, Current, 0, 0, 25420);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1704, Current, 25420);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14761, 0xF8000719, 0); /* implementation */
	tr1 = RTLN(eif_new_type(2027, 0x01).id);
