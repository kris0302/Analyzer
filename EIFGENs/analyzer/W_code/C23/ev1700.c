...
extern EIF_TYPED_VALUE F1700_18644(EIF_REFERENCE);
extern void F1700_18645(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1700_18644 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1700_18645 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1699, Current, 0, 0, 25401);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1699, Current, 25401);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14761, 0xF800071E, 0); /* implementation */
