...
extern EIF_TYPED_VALUE F1693_18608(EIF_REFERENCE);
extern void F1693_18609(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1693_18608 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1693_18609 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1692, Current, 0, 0, 25367);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1692, Current, 25367);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14761, 0xF8000711, 0); /* implementation */
	tr1 = RTLN(eif_new_type(2020, 0x01).id);
