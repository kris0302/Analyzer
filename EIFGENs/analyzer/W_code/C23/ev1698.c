...
extern EIF_TYPED_VALUE F1698_18632(EIF_REFERENCE);
extern void F1698_18633(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1698_18632 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1698_18633 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1697, Current, 0, 0, 25389);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1697, Current, 25389);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14761, 0xF8000714, 0); /* implementation */
