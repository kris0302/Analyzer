...
extern void F1703_18652(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1703_18653(EIF_REFERENCE);
extern void F1703_18654(EIF_REFERENCE);
extern void F1703_18655(EIF_REFERENCE);
extern void F1703_18656(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1703_18657(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1703_18658(EIF_REFERENCE);
extern void F1703_18659(EIF_REFERENCE);
...
void F1703_18652 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1702, Current, 0, 2, 25408);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1702, Current, 25408);
	RTCC(arg1, 1702, l_feature_name, 1, eif_new_type(228, 0x01), 0x01);
	{
		...
		RTCC(arg2, 1702, l_feature_name, 2, typres0, 0x01);
	}
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(5);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(14638, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(5,1);
	ur1 = RTCCL(arg2);
...
EIF_TYPED_VALUE F1703_18653 (EIF_REFERENCE Current)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 1702, Current, 1, 0, 25409);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1702, Current, 25409);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15059, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
	...
	if (tb1) {
		...
		if ((EIF_BOOLEAN) (loc1 > ((EIF_INTEGER_32) 0L))) {
			...
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4705, "keep_head", Result))(Result, ui4_1x);
		}
		RTHOOK(9);
...
void F1703_18654 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1702, Current, 0, 0, 25410);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1702, Current, 25410);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1703_18655 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1702, Current, 0, 0, 25411);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1702, Current, 25411);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
void F1703_18656 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1702, Current, 0, 0, 25412);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1702, Current, 25412);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1703_18657 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1702, Current, 0, 0, 25413);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1702, Current, 25413);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	tb2 = '\0';
	tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(14766, 1693))(Current)).it_b);
	if (tb3) {
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(14766, 1646))(Current)).it_b);
		tb2 = tb3;
	}
	if (tb2) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(14766, 1654))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F1703_18658 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1703_18659 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1702, Current, 0, 0, 25415);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1702, Current, 25415);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14761, 0xF8000717, 0); /* implementation */
	tr1 = RTLN(eif_new_type(2026, 0x01).id);
