...
static const struct desc_info desc_1025[] = {
	...
	{EIF_NON_GENERIC(0x0B2D /*1430*/), 15993, 0},
	{EIF_GENERIC(egt_13_1025), 15994, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0D21 /*1680*/), 15995, 8},
	{EIF_GENERIC(NULL), 15996, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 15997, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 15998, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01DB /*237*/), 15999, 16},
};
void Init1025(void)
{
	IDSC(desc_1025, 0, 1024);
	IDSC(desc_1025 + 1, 1, 1024);
	IDSC(desc_1025 + 32, 583, 1024);
}
