...
extern EIF_TYPED_VALUE F1050_9986(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1050_9987(EIF_REFERENCE);
...
RTOID (F1050_9986)
EIF_TYPED_VALUE F1050_9986 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1049, Current, 0, 0, 16302);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1049, Current, 16302);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F1050_9987)
EIF_TYPED_VALUE F1050_9987 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1049, Current, 0, 0, 16303);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1049, Current, 16303);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (9986,F1050_9986)
	RTOTS (9987,F1050_9987)
}
