...
extern void F1973_23488(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1973_23489_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1973_23489(EIF_REFERENCE);
...
void F1973_23488 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1972, Current, 0, 1, 29520);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1972, Current, 29520);
	RTCC(arg1, 1972, l_feature_name, 1, eif_new_type(228, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1973_23489_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1972, Current, 0, 0, 29521);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1972, Current, 29521);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1973_23489 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15652, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1973_23489_body (Current)).it_r;
