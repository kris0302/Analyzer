...
extern EIF_TYPED_VALUE F1285_13592(EIF_REFERENCE);
...
RTOID (F1285_13592)
EIF_TYPED_VALUE F1285_13592 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1284, Current, 0, 0, 19775);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1284, Current, 19775);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
